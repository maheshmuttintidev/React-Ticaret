        ...
        return (
            <div className="register-container">
                ...
                <form className="register-form" encType="multipart/form-data">
                    ...
                    <input className="input-field fname" type="text" minLength="6" maxLength="20" name="fullName" placeholder="Full Name" required/><br />
                    <input className="input-field rpassword" type="password" minLength="8" maxLength="20" pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$" name="password" placeholder="password" required/><br />
                    <input className="input-field rmobile" minLength="10" maxLength="10" max="9999999999" type="number" name="phoneNumber" pattern="[-+]?[0-9]" placeholder="Mobile Number" required/><br />
