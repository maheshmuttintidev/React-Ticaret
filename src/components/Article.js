...
const SpecialAboutUs = lazy(() => import('./AfterAuthenticationComponents/AboutUs'))
...
const Alert = lazy(() => import('./BeforeAuthenticationComponents/Alert'))
            ...
            <article className="main">
                <Router forceRefresh={true}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="144.84"  height="60" viewBox="0 0 144.84 60">
                                <g id="Group_191" data-name="Group 191" transform="translate(102 417)">
                                    <g id="Group_3" data-name="Group 3" transform="translate(-58.343 -399.994)">
                                        <path className="load-path1" data-name="Path 3781" d="M772.287,480.577s-3.519-1.459-5.361.687-2.932,11.97,0,13.708,7.783,1.171,9.547,0c0,0-3.767,1.918.024-.017s12.7-24.967,13.112-25.269a3.281,3.281,0,0,1,3.187,0c.994.78,1.246,25.924,1.246,25.924" transform="translate(-765.112 -469.261)" fill="none" stroke="#ff2424" stroke-linecap="round" stroke-width="3" />
                                        <path className="load-path2" data-name="Path 3782" d="M2844.48-665.825c-.506-.127-4.877,0-4.877,0" transform="translate(-2817.51 678.681)" fill="none" stroke="#ff2424" stroke-linecap="round" stroke-width="3" />
                                    </g>
                                </g>
                            </svg>
                        </div>
                    ...
                    <Suspense fallback={
                        ...
                        <Route path="/special/about-us" component={SpecialAboutUs} />
                    </Suspense>
                    <Suspense fallback={
                        <div className="loader-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="144.84" height="60" viewBox="0 0 144.84 60">
                        ...
                        <Route path="/terms-and-conditions" component={TermsOfCondition} />
                    </Suspense>
