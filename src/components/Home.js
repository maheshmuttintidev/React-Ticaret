    ...
    return (
     <main>
         ...
         <section className="route-map-container">
            ...
            <div className="flow-map-container">
                ...
                <div className="steps step-two">
                    <img src={ResaleTicketIcon} alt="buy our ticket" />
                ...
                <div className="steps step-three">
                    <img src={ResaleTicketIcon} alt="get your ticket" />
        ...
        <section className="partners-container">
            <h2 className="__h1 move_to_margin">Partners</h2>
            <div className="logos-container">
                <div className="logo_p logo1">
                    <img src="http://getlogo.net/wp-content/uploads/2020/04/bookmyshow-logo-vector.png" alt="partners avatars" />
                </div>
                <div className="logo_p logo2">
                    <img src="https://img01.products.bt.co.uk/content/dam/bt/portal/images/logos/tv/Prime-Video-Color.jpg" alt="partners avatars" />
                </div>
                <div className="logo_p logo3">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Netflix_2015_logo.svg/1280px-Netflix_2015_logo.svg.png" alt="partners avatars" />
                </div>
                <div className="logo_p logo4">
                    <img src="https://upload.wikimedia.org/wikipedia/en/thumb/f/fb/Aha_OTT_Logo.jpeg/170px-Aha_OTT_Logo.jpeg" alt="partners avatars" />
                </div>
            </div>
        </section>
     </main>
