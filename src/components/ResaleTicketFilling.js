                        ...
                        <form className="resale-ticket-filling-form">
                            ...
                            <div className="flex-date-time input-field-container">
                                <div className="date-time-field">
                                    <label htmlFor="" className="normal_p _80_color">Date</label><br />
                                    <input className="input-field date-field" name="date" type="date" />
                                </div>
                                <div className="date-time-field">
                                    <label htmlFor="" className="normal_p _80_color">Show time</label><br />
                            ...
                            <div className="input-field-container">
                                <label htmlFor="heading-tag" className="normal_p _80_color">No of persons in ticket &nbsp;&nbsp;- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No of tickets to sold</label>
                                <div className="">
